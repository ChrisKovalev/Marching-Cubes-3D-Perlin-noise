...
public class Chunk : MonoBehaviour
{
    ...
    void OnEnable() {
        WorldEditor.OnGenerateWorld += generateChunk;
    }
    ...
    void Start() {
        NoiseGenerator = this.transform.GetComponentInParent<NoiseGenerator>();
        generateChunk();
    }
    ...
    public void generateChunk() {
        ...
        _weights = NoiseGenerator.GetNoise(this.transform.position);
